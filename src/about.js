  ...
  return (
    ...
    <section id="about" class="about section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>About</h2>
        <p>Driven by a passion for creativity and problem-solving, I enjoy bringing ideas to life through thoughtful design and efficient code.</p>
      </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>tabithammbone210@gmail.com</span></li>
